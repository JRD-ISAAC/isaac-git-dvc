...
A JupyterLab extension for version control of both code and data using Git and DVC.
This plugin is forked from the popular plugin [jupyterlab_git](https://github.com/jupyterlab/jupyterlab-git)
